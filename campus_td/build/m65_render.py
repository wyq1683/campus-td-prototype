# m65_render.py — M65 渲染（仅出图，不建物体）：白昼 OptiX 终帧
# 英雄机位 M65_Cam（两场 3/4 高角）+ 校园语境机位 M11_CamAerial；结束恢复 M19C_HeroDay。
import bpy, mathutils, os

PREV = r"D:/AI/WorkBuddy/Workspace/2026-09-05-23-46-59/campus_td/previews"
HERO = os.path.join(PREV, "m65_badminton_hero.png")
AERIAL = os.path.join(PREV, "m65_badminton_aerial.png")
