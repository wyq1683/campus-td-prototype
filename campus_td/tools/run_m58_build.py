# run_m58_build.py — Direct TCP runner for M58 driveway blue edge lines (build only)
import sys, os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from blmcp_client import send_execute

CODE = r'exec(compile(open(r"D:/AI/WorkBuddy/Workspace/2026-09-05-23-46-59/campus_td/build/m58_driveway_bluelines.py").read(), "m58", "exec"))'
