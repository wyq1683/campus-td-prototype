# run_m56.py — Direct TCP runner for M56 guardhouse window/door frames (long timeout)
import sys, os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from blmcp_client import send_execute

CODE = r'exec(compile(open(r"D:/AI/WorkBuddy/Workspace/2026-09-05-23-46-59/campus_td/build/m56_guardhouse_frames.py").read(), "m56", "exec"))'
